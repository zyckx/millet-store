<template>
	<view>
		...
		<view class="content">
			...
			<order-all :list='allTradeList' :current="current" @goToPage="goToPage" @delectimg="delectimg"
				@gopay="gopay" @goreceive="goreceive" @goevaluate="goevaluate" @gorepay="gorepay"
				ref="allfun"></order-all>
